...
namespace WinRTXamlToolkit.Controls
{
    ...
    DependencyProperty.Register("Text", typeof(string), typeof(WatermarkTextBox),
    new PropertyMetadata(default(string), (o, args) => ((WatermarkTextBox)o).SetText(args.NewValue)));
